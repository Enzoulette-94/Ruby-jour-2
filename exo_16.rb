...
number_étages <= 25
    ...
    espace = " " * (number_étages - i) # espace * (nb choisi - i) = nb d'espace avant les briques pour que ça se décale en descendant 
    brique = "#" * i 
    puts espace + brique
    
end
puts "t'as vu la bete de pyramide vers la gauche"
end